...
- Easy: factual recall | Medium: comprehension | Hard: analysis
...
export async function POST(request) {
  try {
    ...
    const { text, imageBase64, count = 10, difficulty = "medium", language = "English" } = body;
    ...
    // Reduce batch size to 20 to avoid token overflow and JSON truncation
    const BATCH_SIZE = 20;
    let allQuestions = [];
    let quizTitle    = "";
    let quizTopic    = "";
