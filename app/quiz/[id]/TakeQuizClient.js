      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-3 mt-3">
            <span className="bg-[var(--cream)] border border-[var(--border)] px-2.5 py-1 rounded-full text-xs text-[var(--muted)]">{quiz.questions.length} questions</span>
        ...
        <div className="max-w-2xl mx-auto px-4 py-10">
          ...
          {revealed && (
            <button onClick={next} disabled={submitting}
              ...
              {submitting ? "Submitting…" : current + 1 >= total ? "See results" : "Next question"}
              <Icons.ChevronRight/>
            </button>
          )}
        </div>
